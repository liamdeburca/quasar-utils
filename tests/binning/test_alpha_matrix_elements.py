...
from quasar_utils.binning.alpha_matrix_elements import (
    _alpha_matrix_elements as cython_alpha_matrix_elements,
)

# Import both implementations
from quasar_utils.binning.binning import (
    alpha_matrix_elements as numba_alpha_matrix_elements,
)
